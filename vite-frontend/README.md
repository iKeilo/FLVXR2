...
---
#### 安装特定版本
从 [Releases](https://github.com/iKeilo/FLVXR2/releases) 页面复制对应版本的安装命令，脚本会自动安装该版本而非最新版。

面板端（以 2.1.0 为例）：
```bash
curl -L https://github.com/iKeilo/FLVXR2/releases/download/2.1.0/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
节点端（以 2.1.0 为例）：
```bash
curl -L https://github.com/iKeilo/FLVXR2/releases/download/2.1.0/install.sh -o install.sh && chmod +x install.sh && ./install.sh
```
